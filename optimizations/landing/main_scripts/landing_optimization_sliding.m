...
%             opti.subject_to(sliding_x_pos <= 0);
%             opti.subject_to(sliding_x_neg >= 0);
%             opti.subject_to(sliding_y_pos <= 0);
%             opti.subject_to(sliding_y_neg >= 0);
            
            opti.subject_to(fk(xyz_idx(3))*((c(xyz_idx(1),k+1)-ck(xyz_idx(1)))/dt(k))*sliding_x_pos <= 0.001);
            opti.subject_to(fk(xyz_idx(3))*((c(xyz_idx(1),k+1)-ck(xyz_idx(1)))/dt(k))*sliding_x_neg >= -0.001);
            opti.subject_to(fk(xyz_idx(3))*((c(xyz_idx(2),k+1)-ck(xyz_idx(2)))/dt(k))*sliding_y_pos >= 0.001);
            opti.subject_to(fk(xyz_idx(3))*((c(xyz_idx(2),k+1)-ck(xyz_idx(2)))/dt(k))*sliding_y_neg <= -0.001);
        end
...
Qc_val = [0 0 0]';
Qf_val = [0.001/f_max_val 0.001/f_max_val 0.0001/f_max_val]';
