...
% opti.subject_to(c([3 6 9 12]', end) == zeros(4, 1));


%% reference trajectories
q_init_val = [0 0 0.6 pi/6 pi/4 0]';
qd_init_val = [0 0 0.0 2.5 0 -2]';
...
QX_val = [0 0 10, 10 10 0, 10 10 10, 100 100 10]';
QN_val = [0 0 500, 100 100 0, 10 10 10, 10 10 10]';
Qc_val = [0 0 0]';
Qf_val = [0.0001 0.0001 0.0001]';
% Qf_val = [0 0 0]';
