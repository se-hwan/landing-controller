...
q_init_val = [0 0 0.6 (pi/6)*(2*rand(1)-1) (pi/3)*(2*rand(1)-1) 2*rand(1)-1]';
qd_init_val = [2*rand(1,3)-1 4*rand(1, 2)-1.5 -3]';

q_init_val = [0         0    0.6    pi/4  pi/4 0]';
