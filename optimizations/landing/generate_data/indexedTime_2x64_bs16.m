function [x16, state] = indexedTime_2x64_bs16(x0, params, varargin)
%INDEXEDTIME_2X64_BS16 Function implementing an imported ONNX network.
%
...
%
% [X16] = indexedTime_2x64_bs16(X0, PARAMS)
%			- Evaluates the imported ONNX network INDEXEDTIME_2X64_BS16 with input(s)
%			X0 and the imported network parameters in PARAMS. Returns
%			network output(s) in X16.
%
% [X16, STATE] = indexedTime_2x64_bs16(X0, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = indexedTime_2x64_bs16(X0, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
[Vars, NumDims] = packageVariables(params, {'x0'}, {x0}, [3]);
...
% Function to validate inputs to indexedTime_2x64_bs16:
p = inputParser;
...
x0 = permuteInputVar(x0, inputDataPerms{1}, 3);
% Check input size(s):
checkInputSize(size(x0), {1 1 9}, "x0");
end
