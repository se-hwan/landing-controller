...
training_data_normalized.output = zeros(732, 1);
...
%     td      = zeros(4, 1);
    ...
    training_data_normalized.output(:, data_entry) = [X_norm(:); U_norm(:); jpos_norm(:)];
...
[X_dn, U_dn, jpos_dn] = data_denormalization_noGRF(normalized_data_sample);
