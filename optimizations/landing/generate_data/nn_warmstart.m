...
nn_params = importONNXFunction(modelfile,'nn_landing');
...
q_init_val = [0 0 0 (0.25)*(2*rand(1)-1) (pi/4)*(2*rand(1)-1) (.25)*(2*rand(1)-1)]';     % major pitch
qd_init_val = [0.1*(2*rand(1,3)-1) 1*(2*rand(1, 2)-1) -3*rand(1)-1]';

% q_init_val =  [0           0     0.56848     0.10272     -0.7775     0.14126]';
% qd_init_val = [0.085372   -0.098341    0.064926     0.53467     0.99427      -1.683]';
%% timestep parameters
...
t_eval_nn = toc; disp("NN EVALUATION TIME: " + num2str(t_eval_nn));
...
t_solve(:, n) = [t_eval_nn; t_solve_nn_ws; t_solve_cs; t_solve_ws];
