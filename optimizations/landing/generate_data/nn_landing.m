function [x16, state] = nn_landing(x0, params, varargin)
%NN_LANDING Function implementing an imported ONNX network.
%
...
%
% [X16] = nn_landing(X0, PARAMS)
%			- Evaluates the imported ONNX network NN_LANDING with input(s)
%			X0 and the imported network parameters in PARAMS. Returns
%			network output(s) in X16.
%
% [X16, STATE] = nn_landing(X0, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = nn_landing(X0, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to nn_landing:
p = inputParser;
