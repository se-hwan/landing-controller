function [x16, state] = indexedTime_2x512_2(x0, params, varargin)
%INDEXEDTIME_2X512_2 Function implementing an imported ONNX network.
%
...
%
% [X16] = indexedTime_2x512_2(X0, PARAMS)
%			- Evaluates the imported ONNX network INDEXEDTIME_2X512_2 with input(s)
%			X0 and the imported network parameters in PARAMS. Returns
%			network output(s) in X16.
%
% [X16, STATE] = indexedTime_2x512_2(X0, PARAMS)
%			- Additionally returns state variables in STATE. When training,
%			use this form and set TRAINING to true.
%
% [__] = indexedTime_2x512_2(X0, PARAMS, 'NAME1', VAL1, 'NAME2', VAL2, ...)
...
% Function to validate inputs to indexedTime_2x512_2:
p = inputParser;
