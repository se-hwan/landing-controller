...
%     q_init_val = [0 0 0 (.25)*(2*rand(1)-1) (pi/4)*(2*rand(1)-1) (.25)*(2*rand(1)-1)]';     % major pitch
q_init_val = [0 0 0 (pi/4)*(2*rand(1)-1) (.25)*(2*rand(1)-1) (.25)*(2*rand(1)-1)]';     % major roll
qd_init_val = [0.5*(2*rand(1,3)-1) 1*(2*rand(1, 2)-1) -3.5*rand(1)-1]';

% q_init_val  = [         0         0    0.5065    0.0477    0.3972   -0.0016]';
% qd_init_val = [    0.3651   -0.4320    0.4685   -0.8025    0.0940   -2.6119]';
